...
<main class="new-home">
    <section class="home-about-section about-page-story">
        <div class="container">
            <div class="home-about-grid">
                <div class="home-about-media">
                    <img src="<?php echo SITE_URL; ?>/images/home/yoga-warrior-pose.jpeg" alt="Manpreet Singh Sangha yoga practice">
                </div>
                <div class="home-about-copy">
                    <span class="home-kicker">About Us</span>
                    <h2>Understanding Yourself, Then Understanding Others</h2>
                    ...
                    <p>Despite comfortable living, faster cars, and instant communication, we still struggle to find time to relax, rest, or communicate with each other. We always seem to be running out of time. While modern amenities offer convenience, they do not necessarily bring peace or lasting happiness.</p>
    ...
    <section class="home-document-section">
        <div class="container">
            <div class="home-section-heading">
                <span class="home-kicker">Certification</span>
                <h2>Yoga Teacher Certification</h2>
                <p>Professional training and certification supporting the work at Dive Into Yourself.</p>
            </div>
